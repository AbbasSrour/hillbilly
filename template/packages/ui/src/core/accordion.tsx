...
function AccordionItem({
  ...
  style,
  ...props
}: ComponentProps<typeof AccordionPrimitive.Item> & VariantProps<typeof accordionItemVariants>) {
  return (
    <AccordionPrimitive.Item
      data-slot="accordion-item"
      className={cn(accordionItemVariants({ style }), className)}
      {...props}
    />
  );
}
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(accordionTriggerVariants({ style }), className)}
        {...props}
      >
        {children}
        <ChevronDownIcon className={cn(accordionIconVariants({ iconStyle }))} />
      </AccordionPrimitive.Trigger>
