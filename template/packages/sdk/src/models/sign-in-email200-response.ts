 ...
 */
export interface SignInEmail200Response {
    'redirect': SignInEmail200ResponseRedirectEnum;
    /**
     * Session token
     */
    'token': string;
...
export const SignInEmail200ResponseRedirectEnum = {
    False: false
} as const;

export type SignInEmail200ResponseRedirectEnum = typeof SignInEmail200ResponseRedirectEnum[keyof typeof SignInEmail200ResponseRedirectEnum];
