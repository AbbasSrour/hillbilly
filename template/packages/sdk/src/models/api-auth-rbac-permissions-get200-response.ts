...
// @ts-ignore
import type { ApiAuthRbacPermissionsGet200ResponsePermissionsInner } from "./api-auth-rbac-permissions-get200-response-permissions-inner";

export interface ApiAuthRbacPermissionsGet200Response {
  permissions: Array<ApiAuthRbacPermissionsGet200ResponsePermissionsInner>;
  total: number;
}
