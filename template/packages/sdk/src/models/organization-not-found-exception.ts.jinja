...
export interface OrganizationNotFoundException {
    'statusCode': OrganizationNotFoundExceptionStatusCodeEnum;
    'message': OrganizationNotFoundExceptionMessageEnum;
    'error': OrganizationNotFoundExceptionErrorEnum;
}

export const OrganizationNotFoundExceptionStatusCodeEnum = {
    NUMBER_404: 404
} as const;

export type OrganizationNotFoundExceptionStatusCodeEnum = typeof OrganizationNotFoundExceptionStatusCodeEnum[keyof typeof OrganizationNotFoundExceptionStatusCodeEnum];
export const OrganizationNotFoundExceptionMessageEnum = {
    ErrorOrganizationNotFound: 'error.organization.notFound'
} as const;

export type OrganizationNotFoundExceptionMessageEnum = typeof OrganizationNotFoundExceptionMessageEnum[keyof typeof OrganizationNotFoundExceptionMessageEnum];
export const OrganizationNotFoundExceptionErrorEnum = {
    NotFound: 'Not Found'
} as const;

export type OrganizationNotFoundExceptionErrorEnum = typeof OrganizationNotFoundExceptionErrorEnum[keyof typeof OrganizationNotFoundExceptionErrorEnum];
