...
export interface OrganizationDto {
  ...
  name: string;
  /**
   * URL or path to organization logo/image
   */
  image?: string;
  /**
  ...
  phone?: string;
  /**
   * Region/State of the organization
   */
  region?: string;
  /**
  ...
  address?: string;
  /**
   * Whether the organization is banned
   */
  banned: boolean;
  /**
  ...
  banReason?: string;
  /**
   * Expiration date of the ban (if banned)
   */
  banExpires?: string;
  /**
   * Whether orders require manual approval. If false, orders are auto-accepted.
   */
  requiresApproval: boolean;
  translations?: Array<AbstractTranslationDto>;
}
