...
export interface ApiAuthRbacUserPermissionsGet200ResponsePermissionsInner {
    [key: string]: any;

    'id': string;
    'name': string;
    'code': ApiAuthRbacUserPermissionsGet200ResponsePermissionsInnerCodeEnum;
    'description'?: string;
}

export const ApiAuthRbacUserPermissionsGet200ResponsePermissionsInnerCodeEnum = {
    UserView: 'user.view',
...
export type ApiAuthRbacUserPermissionsGet200ResponsePermissionsInnerCodeEnum = typeof ApiAuthRbacUserPermissionsGet200ResponsePermissionsInnerCodeEnum[keyof typeof ApiAuthRbacUserPermissionsGet200ResponsePermissionsInnerCodeEnum];
