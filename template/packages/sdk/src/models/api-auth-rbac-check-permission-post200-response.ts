...
export interface ApiAuthRbacCheckPermissionPost200Response {
    'hasPermission': boolean;
    'checked': Array<ApiAuthRbacCheckPermissionPost200ResponseCheckedEnum>;
    'userPermissions': Array<ApiAuthRbacCheckPermissionPost200ResponseUserPermissionsEnum>;
}

export const ApiAuthRbacCheckPermissionPost200ResponseCheckedEnum = {
    UserView: 'user.view',
    ...
    OrganizationBan: 'organization.ban',
    OrganizationUnban: 'organization.unban'
} as const;

export type ApiAuthRbacCheckPermissionPost200ResponseCheckedEnum = typeof ApiAuthRbacCheckPermissionPost200ResponseCheckedEnum[keyof typeof ApiAuthRbacCheckPermissionPost200ResponseCheckedEnum];
export const ApiAuthRbacCheckPermissionPost200ResponseUserPermissionsEnum = {
    UserView: 'user.view',
    UserCreate: 'user.create',
    UserUpdate: 'user.update',
    UserDelete: 'user.delete',
...
export type ApiAuthRbacCheckPermissionPost200ResponseUserPermissionsEnum = typeof ApiAuthRbacCheckPermissionPost200ResponseUserPermissionsEnum[keyof typeof ApiAuthRbacCheckPermissionPost200ResponseUserPermissionsEnum];
