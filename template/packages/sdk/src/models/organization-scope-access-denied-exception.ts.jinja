...
export type OrganizationScopeAccessDeniedExceptionStatusCodeEnum =
  (typeof OrganizationScopeAccessDeniedExceptionStatusCodeEnum)[keyof typeof OrganizationScopeAccessDeniedExceptionStatusCodeEnum];
...
export type OrganizationScopeAccessDeniedExceptionMessageEnum =
  (typeof OrganizationScopeAccessDeniedExceptionMessageEnum)[keyof typeof OrganizationScopeAccessDeniedExceptionMessageEnum];
export const OrganizationScopeAccessDeniedExceptionErrorEnum = {
  Forbidden: "Forbidden",
} as const;

export type OrganizationScopeAccessDeniedExceptionErrorEnum =
  (typeof OrganizationScopeAccessDeniedExceptionErrorEnum)[keyof typeof OrganizationScopeAccessDeniedExceptionErrorEnum];
