...
// @ts-ignore
import type { ApiAuthAccountInfoGet200ResponseUser } from "./api-auth-account-info-get200-response-user";

export interface ApiAuthAccountInfoGet200Response {
  user: ApiAuthAccountInfoGet200ResponseUser;
  data: { [key: string]: any };
}
