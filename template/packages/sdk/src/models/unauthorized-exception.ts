...
export interface UnauthorizedException {
    'statusCode': UnauthorizedExceptionStatusCodeEnum;
    'message': UnauthorizedExceptionMessageEnum;
    'error': UnauthorizedExceptionErrorEnum;
}

export const UnauthorizedExceptionStatusCodeEnum = {
    NUMBER_401: 401
} as const;

export type UnauthorizedExceptionStatusCodeEnum = typeof UnauthorizedExceptionStatusCodeEnum[keyof typeof UnauthorizedExceptionStatusCodeEnum];
export const UnauthorizedExceptionMessageEnum = {
    ErrorAuthUnauthorized: 'error.auth.unauthorized'
} as const;

export type UnauthorizedExceptionMessageEnum = typeof UnauthorizedExceptionMessageEnum[keyof typeof UnauthorizedExceptionMessageEnum];
export const UnauthorizedExceptionErrorEnum = {
    Unauthorized: 'Unauthorized'
} as const;

export type UnauthorizedExceptionErrorEnum = typeof UnauthorizedExceptionErrorEnum[keyof typeof UnauthorizedExceptionErrorEnum];
