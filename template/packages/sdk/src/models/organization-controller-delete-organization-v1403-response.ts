...
// @ts-ignore
import type { OrganizationScopeAccessDenied2Exception } from './organization-scope-access-denied2-exception';
// May contain unused imports in some cases
// @ts-ignore
import type { OrganizationScopeAccessDeniedException } from './organization-scope-access-denied-exception';

/**
 * @type OrganizationControllerDeleteOrganizationV1403Response
 */
export type OrganizationControllerDeleteOrganizationV1403Response = OrganizationScopeAccessDenied2Exception | OrganizationScopeAccessDeniedException;
