...
export interface DeleteUser200Response {
     ...
     */
    'message': DeleteUser200ResponseMessageEnum;
}

export const DeleteUser200ResponseMessageEnum = {
    UserDeleted: 'User deleted',
    VerificationEmailSent: 'Verification email sent'
} as const;

export type DeleteUser200ResponseMessageEnum = typeof DeleteUser200ResponseMessageEnum[keyof typeof DeleteUser200ResponseMessageEnum];
