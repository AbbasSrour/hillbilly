...
// @ts-ignore
import type { ApiAuthRbacUserPermissionsGet200ResponsePermissionsInner } from "./api-auth-rbac-user-permissions-get200-response-permissions-inner";
// May contain unused imports in some cases
// @ts-ignore
import type { ApiAuthRbacUserPermissionsGet200ResponseRole } from "./api-auth-rbac-user-permissions-get200-response-role";

export interface ApiAuthRbacUserPermissionsGet200Response {
  role: ApiAuthRbacUserPermissionsGet200ResponseRole | null;
  permissions: Array<ApiAuthRbacUserPermissionsGet200ResponsePermissionsInner>;
}
