...
export interface ChangeEmail200Response {
     ...
     */
    'message'?: ChangeEmail200ResponseMessageEnum;
}

export const ChangeEmail200ResponseMessageEnum = {
    EmailUpdated: 'Email updated',
    VerificationEmailSent: 'Verification email sent'
} as const;

export type ChangeEmail200ResponseMessageEnum = typeof ChangeEmail200ResponseMessageEnum[keyof typeof ChangeEmail200ResponseMessageEnum];
