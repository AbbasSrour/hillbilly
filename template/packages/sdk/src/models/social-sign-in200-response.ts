 ...
 */
export interface SocialSignIn200Response {
    'token': string;
    'user': User;
    'url'?: string;
    'redirect': SocialSignIn200ResponseRedirectEnum;
}

export const SocialSignIn200ResponseRedirectEnum = {
    False: false
} as const;

export type SocialSignIn200ResponseRedirectEnum = typeof SocialSignIn200ResponseRedirectEnum[keyof typeof SocialSignIn200ResponseRedirectEnum];
