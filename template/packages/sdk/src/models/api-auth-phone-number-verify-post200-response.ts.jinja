...
// @ts-ignore
import type { ApiAuthPhoneNumberVerifyPost200ResponseUser } from './api-auth-phone-number-verify-post200-response-user';

export interface ApiAuthPhoneNumberVerifyPost200Response {
    /**
     * Indicates if the verification was successful
     */
    'status': ApiAuthPhoneNumberVerifyPost200ResponseStatusEnum;
    /**
     * Session token if session is created, null if disableSession is true or no session is created
     */
    'token'?: string;
    'user'?: ApiAuthPhoneNumberVerifyPost200ResponseUser;
}

export const ApiAuthPhoneNumberVerifyPost200ResponseStatusEnum = {
    True: true
} as const;

export type ApiAuthPhoneNumberVerifyPost200ResponseStatusEnum = typeof ApiAuthPhoneNumberVerifyPost200ResponseStatusEnum[keyof typeof ApiAuthPhoneNumberVerifyPost200ResponseStatusEnum];
