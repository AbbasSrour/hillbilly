...
export interface ApiAuthRbacPermissionsGet200ResponsePermissionsInner {
    [key: string]: any;

    'id': string;
    'name': string;
    'code': ApiAuthRbacPermissionsGet200ResponsePermissionsInnerCodeEnum;
    'description'?: string;
}

export const ApiAuthRbacPermissionsGet200ResponsePermissionsInnerCodeEnum = {
    UserView: 'user.view',
...
export type ApiAuthRbacPermissionsGet200ResponsePermissionsInnerCodeEnum = typeof ApiAuthRbacPermissionsGet200ResponsePermissionsInnerCodeEnum[keyof typeof ApiAuthRbacPermissionsGet200ResponsePermissionsInnerCodeEnum];
