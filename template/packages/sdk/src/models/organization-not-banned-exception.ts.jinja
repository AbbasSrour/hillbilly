...
export type OrganizationNotBannedExceptionStatusCodeEnum =
  (typeof OrganizationNotBannedExceptionStatusCodeEnum)[keyof typeof OrganizationNotBannedExceptionStatusCodeEnum];
export const OrganizationNotBannedExceptionMessageEnum = {
  ErrorOrganizationNotBanned: "error.organization.notBanned",
} as const;

export type OrganizationNotBannedExceptionMessageEnum =
  (typeof OrganizationNotBannedExceptionMessageEnum)[keyof typeof OrganizationNotBannedExceptionMessageEnum];
export const OrganizationNotBannedExceptionErrorEnum = {
  BadRequest: "Bad Request",
} as const;

export type OrganizationNotBannedExceptionErrorEnum =
  (typeof OrganizationNotBannedExceptionErrorEnum)[keyof typeof OrganizationNotBannedExceptionErrorEnum];
