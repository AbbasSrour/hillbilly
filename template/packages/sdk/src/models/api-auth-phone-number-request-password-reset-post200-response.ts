...
export interface ApiAuthPhoneNumberRequestPasswordResetPost200Response {
    /**
     * Indicates if the OTP was sent successfully
     */
    'status': ApiAuthPhoneNumberRequestPasswordResetPost200ResponseStatusEnum;
}

export const ApiAuthPhoneNumberRequestPasswordResetPost200ResponseStatusEnum = {
    True: true
} as const;

export type ApiAuthPhoneNumberRequestPasswordResetPost200ResponseStatusEnum = typeof ApiAuthPhoneNumberRequestPasswordResetPost200ResponseStatusEnum[keyof typeof ApiAuthPhoneNumberRequestPasswordResetPost200ResponseStatusEnum];
