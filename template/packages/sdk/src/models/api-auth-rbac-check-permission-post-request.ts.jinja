...
// @ts-ignore
import type { ApiAuthRbacCheckPermissionPostRequestPermission } from './api-auth-rbac-check-permission-post-request-permission';

export interface ApiAuthRbacCheckPermissionPostRequest {
    'permission': ApiAuthRbacCheckPermissionPostRequestPermission;
}
