...
// @ts-ignore
import type { HealthCheckerControllerCheck200ResponseErrorValue } from "./health-checker-controller-check200-response-error-value";
// May contain unused imports in some cases
// @ts-ignore
import type { HealthCheckerControllerCheck200ResponseInfoValue } from "./health-checker-controller-check200-response-info-value";

export interface HealthCheckerControllerCheck200Response {
  status?: string;
  info?: { [key: string]: HealthCheckerControllerCheck200ResponseInfoValue };
  error?: { [key: string]: HealthCheckerControllerCheck200ResponseErrorValue };
  details?: { [key: string]: HealthCheckerControllerCheck200ResponseErrorValue };
}
