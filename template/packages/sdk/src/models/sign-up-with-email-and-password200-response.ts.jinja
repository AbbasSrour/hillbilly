...
// @ts-ignore
import type { SignUpWithEmailAndPassword200ResponseUser } from './sign-up-with-email-and-password200-response-user';

export interface SignUpWithEmailAndPassword200Response {
    /**
