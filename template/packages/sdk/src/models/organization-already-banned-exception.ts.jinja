...
export type OrganizationAlreadyBannedExceptionStatusCodeEnum =
  (typeof OrganizationAlreadyBannedExceptionStatusCodeEnum)[keyof typeof OrganizationAlreadyBannedExceptionStatusCodeEnum];
...
export type OrganizationAlreadyBannedExceptionMessageEnum =
  (typeof OrganizationAlreadyBannedExceptionMessageEnum)[keyof typeof OrganizationAlreadyBannedExceptionMessageEnum];
export const OrganizationAlreadyBannedExceptionErrorEnum = {
  BadRequest: "Bad Request",
} as const;

export type OrganizationAlreadyBannedExceptionErrorEnum =
  (typeof OrganizationAlreadyBannedExceptionErrorEnum)[keyof typeof OrganizationAlreadyBannedExceptionErrorEnum];
