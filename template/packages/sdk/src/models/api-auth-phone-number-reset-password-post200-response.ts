...
export interface ApiAuthPhoneNumberResetPasswordPost200Response {
    /**
     * Indicates if the password was reset successfully
     */
    'status': ApiAuthPhoneNumberResetPasswordPost200ResponseStatusEnum;
}

export const ApiAuthPhoneNumberResetPasswordPost200ResponseStatusEnum = {
    True: true
} as const;

export type ApiAuthPhoneNumberResetPasswordPost200ResponseStatusEnum = typeof ApiAuthPhoneNumberResetPasswordPost200ResponseStatusEnum[keyof typeof ApiAuthPhoneNumberResetPasswordPost200ResponseStatusEnum];
