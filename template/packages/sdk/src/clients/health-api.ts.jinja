...
export const HealthApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    healthCheckerControllerCheck: async (
...
export const HealthApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async healthCheckerControllerCheck(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<HealthCheckerControllerCheck200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.healthCheckerControllerCheck(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["HealthApi.healthCheckerControllerCheck"]?.[localVarOperationServerIndex]
          ?.url;
...
export const HealthApiFactory = function (
  ...
  return {
    ...
    healthCheckerControllerCheck(
      ...
      return localVarFp
        .healthCheckerControllerCheck(options)
