...
const { status, data } = await apiInstance.apiAuthRbacRoleGet(
    roleId
);
```
...
const { status, data } = await apiInstance.apiAuthRbacRolePermissionsGet(
    roleId
);
```
...
const { status, data } = await apiInstance.apiAuthRbacRolePut(
    apiAuthRbacRolePutRequest
);
```
...
const { status, data } = await apiInstance.apiAuthRbacRolesPost(
    apiAuthRbacRolesPostRequest
);
```
