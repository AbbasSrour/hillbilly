...
const { status, data } = await apiInstance.userControllerBlockUserV1(
    id
);
```
...
const { status, data } = await apiInstance.userControllerCreateUserV1(
    createUserDto
);
```
...
const { status, data } = await apiInstance.userControllerDeleteUserV1(
    id
);
```
...
const { status, data } = await apiInstance.userControllerGetUserV1(
    id
);
```
...
const { status, data } = await apiInstance.userControllerUnblockUserV1(
    id
);
```
...
const { status, data } = await apiInstance.userControllerUpdateCurrentUserV1(
    updateCurrentUserDto
);
```
...
const { status, data } = await apiInstance.userControllerUpdateUserV1(
    id,
    updateUserDto
);
```
