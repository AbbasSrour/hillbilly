...
```typescript
import { OrganizationApi, Configuration, OrganizationBanDto } from "./api";
...
```typescript
import { OrganizationApi, Configuration, CreateOrganizationDto } from "./api";
...
const { status, data } =
  await apiInstance.organizationControllerCreateOrganizationV1(createOrganizationDto);
```
...
const { status, data } = await apiInstance.organizationControllerDeleteOrganizationV1(id);
```
...
const { status, data } = await apiInstance.organizationControllerGetOrganizationV1(id);
```
...
const { status, data } = await apiInstance.organizationControllerUnbanOrganizationV1(id);
```
...
```typescript
import { OrganizationApi, Configuration, UpdateMyOrganizationDto } from "./api";
...
const { status, data } =
  await apiInstance.organizationControllerUpdateMyOrganizationV1(updateMyOrganizationDto);
```
...
```typescript
import { OrganizationApi, Configuration, UpdateOrganizationDto } from "./api";
